...
## Dockerize the application
    ...
    docker build -t bala-spring-boot-hello .
## List docker image
...
## Run and verify the docker images
    ...
    docker run -p 8080:8080 bala-spring-boot-hello:latest
    http://localhost:8080/hello
    http://localhost:8080/actuator/health

## Create ECR for Spring app
```Bash
    aws cloudformation deploy --template-file ecr-template.yml --stack-name bala-spring-ecr-repo 
```
## Create Code build pipe (Code Build Service)
